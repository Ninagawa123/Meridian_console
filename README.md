...
　　「このアプリがデバイスに変更を加えることを許可しますか？」→「はい」<br>
  3. 「受信の規則」<br>
     -「受信の規則」をクリックし, 右側の「新しい規則」をクリックします.<br>
     - 「ポート」を選択し,「次へ」をクリックします.<br>
     - 「UDP」を選択し,「特定のローカルポート」に「22222」を入力し,「次へ」をクリックします.<br>
     - 「接続の許可する」を選択し,「次へ」をクリックします.<br>
     - 「ドメイン」「プライベート」「パブリック」の全てにチェックを入れ,「次へ」をクリックします.<br>
     - 「名前」に「Meridian_22222」を入力し,「完了」をクリックします.<br>
  4. 「送信の規則」<br>
     - 「送信の規則」をクリックし, 右側の「新しい規則」をクリックします.<br>
     - 「ポート」を選択し, 「次へ」をクリックします.<br>
     - 「UDP」を選択し, 「特定のローカルポート」に「22224」を入力し,「次へ」をクリックします.<br>
     - 「接続を許可する」を選択し, 「次へ」をクリックします.<br>
     - 「ドメイン」「プライベート」「パブリック」の全てにチェックを入れ,「次へ」をクリックします.<br>
     - 「名前」に「Meridian_22224」を入力し, 「完了」をクリックします.<br>
</p>
</details>
